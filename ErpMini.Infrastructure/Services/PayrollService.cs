...
public class PayrollService : IPayrollService
{
    ...
    public async Task<IEnumerable<PayrollDto>> GetByMonthYearAsync(int month, int year)
    {
        return await _context.Payrolls
            .Include(p => p.Employee)
                .ThenInclude(e => e.Department)
    ...
    public async Task<bool> GenerateBulkAsync(int month, int year, string generatedBy)
    {
        // Get all active employees who don't have payroll yet for this month
    ...
    public async Task<IEnumerable<PayrollSummaryDto>> GetSummaryAsync()
    {
        return await _context.Payrolls
